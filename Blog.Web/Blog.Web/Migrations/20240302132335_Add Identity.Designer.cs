...
namespace Blog.Web.Migrations
{
    ...
    [Migration("20240302132335_Add Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blog.Web.Data.Entities.Identity.RoleEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Blog.Web.Data.Entities.Identity.UserRoleEntity", b =>
                {
                    b.HasOne("Blog.Web.Data.Entities.Identity.RoleEntity", "Role")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("Blog.Web.Data.Entities.Identity.RoleEntity", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
